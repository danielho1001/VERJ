...
//  Pogo
//
//  Created by Daniel Ho on 5/8/14.
//  Copyright (c) 2014 Daniel Ho. All rights reserved.
//
...
@property (strong, nonatomic) IBOutlet UIImageView *color;
